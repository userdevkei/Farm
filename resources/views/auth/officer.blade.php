...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Create Account | Extension Officers Registration') }}</div>

                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('officers.store') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="specialization" class="col-md-3 col-form-label text-md-right">{{ __('Specialization') }}</label>

                                <div class="col-md-8">
                                    <input id="specialization" type="text" class="form-control text-capitalize @error('specialization') is-invalid @enderror" name="specialization" value="{{ old('specialization') }}" required autocomplete="specialization" placeholder="area of specialization eg. Maize Diseases" autofocus>
                            ...
                            <div class="form-group row">
                                {!! Form::label('flexibility', ('Flexibility'), ['class'=> 'col-md-3 col-form-label text-md-right']) !!}
                                <div class="col-md-8">
                                    {!! Form::select('flexibility', array('Available' => 'Available','Flexible' => 'Flexible', 'On Request' => 'On Request'),'', ['class'=> 'form-control', 'placeholder' => 'When Can You Be Available']) !!}
                                </div>
                            </div>
                            ...
                            <input id="level" type="hidden" name="level" value="Officer">
                            <div class="form-group row">
                                <label for="password" class="col-md-3 col-form-label text-md-right">{{ __('Password') }}</label>

                                <div class="col-md-8">
                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="Password With at Least 6 Characters">
