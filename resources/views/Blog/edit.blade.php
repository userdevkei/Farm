        ...
        <div class="d-flex justify-content-center">
            <div class="col-md-6 col-sm-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['method' => 'POST', 'action' => ['BlogController@update', $post->id], 'enctype' => 'multipart/form-data']) !!}
                        <div class="form-group row">
                            {!! Form::label('title',('Heading :'), ['class' => 'col-md-3 col-sm-3 text-right']) !!}
                            {!! Form::text('title',$post->title,['class' => 'col-md-8 col-sm-8 form-control text-capitalize'], 'autofocus') !!}
                        </div>
                        <div class="form-group row">
                            {!! Form::label('message',('Message :'), ['class' => 'col-md-3 col-sm-3 text-right']) !!}
                            {!! Form::textarea('message',$post->message,['class' => 'col-md-8 col-sm-8 form-control', 'rows' => '3']) !!}
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="row mb-0 form-group">
                           ...
                           <button class="btn btn-sm btn-success offset-md-3" type="submit" title="update this post">
